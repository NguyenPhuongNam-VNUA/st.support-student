    ...
    <div class="page-header-content d-lg-flex border-top">
        <div class="d-flex">
            <div class="breadcrumb py-2">
                ...
                <a href="{{route('medicaladmin.doctorroles.index')}}" class="breadcrumb-item active">Chuyên khoa</a>
            </div>
        </div>
        ...
        Livewire.on('openDeleteModel', (event) => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    Swal.fire({
                        title: "Xóa chuyên khoa thành công!",
                        icon: "success"
                    });
                }
            });
...
<div class="content">
    <!-- Content -->
    <livewire:medical-admin.doctor-role.doctor-role-index />
    <!-- /content -->
</div>
@endsection