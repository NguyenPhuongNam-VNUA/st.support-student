    ...
    <div class="page-header-content d-lg-flex border-top">
        <div class="d-flex">
            <div class="breadcrumb py-2">
                ...
                <a href="{{route('dormitoryadmin.dormitories.index')}}" class="breadcrumb-item active">Ký túc xá</a>
            </div>
        </div>
...
<script>
    document.addEventListener('livewire:init', () => {
        Livewire.on('openDeleteModel', (event) => {
            Swal.fire({
                title: "Bạn có chắc xóa tòa nhà này không?",
                icon: "warning",
...
<div class="content">
    <!-- Content -->
    <livewire:dormitory-admin.dormitory.dormitory-index />
    <!-- /content -->
</div>
@endsection