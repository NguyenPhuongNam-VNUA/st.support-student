        ...
        <div class="row-6">
            ...
            <div class="col-4">
                <div class="top-banner">
                    ...
                    <div class="right-banner-6">
                        <a href="grid-list.html" class="r-banner">
                            <img src="{{asset('assets/client/image/kham-sk002.png')}}" class="img-fluid" alt="banner-image">
                        </a>
                    ...
                    <div class="col">
                        ...
                        <div class="category-6">
                            <div class="cate-6 owl-carousel owl-theme">
                                <div class="items">
                                    <div class="cate-back" style="background-image:url({{asset('assets/client/image/CL.jpg')}});">
                                        <div class="cat-box">
                                ...
                                <div class="items">
                                    <div class="cate-back" style="background-image: url({{asset('assets/client/image/CL.jpg')}});">
                                        <div class="cat-box">
                                            <h2>Đau mắt đỏ</h2>
                                            <ul class="category-link">
                                                <li><a href="grid-list.html"><i class="fa fa-angle-right"></i>Shimp jumbo</a></li>
                                                <li><a href="grid-list.html"><i class="fa fa-angle-right"></i>Fresh mussel</a></li>
                                                <li><a href="grid-list.html"><i class="fa fa-angle-right"></i>Green mussel</a></li>
                                                <li><a href="grid-list.html"><i class="fa fa-angle-right"></i>Green seafood</a></li>
                                                <li><a href="grid-list.html"><i class="fa fa-angle-right"></i>Fresh seafish</a></li>
                                                <li><a href="grid-list.html"><i class="fa fa-angle-right"></i>Prod of india</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="tab-content tab-pro-slider">
                                    ...
                                    <div class="doctor-list">
                                        ...
                                        <div class="doctor-item">
                                            <div class="doctor-img">
                                                <img src="{{asset('assets/client/image/avatar-mh.jpg')}}" alt="Bs. Nguyễn Thục Khanh" class="img-fluid">
                                            </div>
                                        ...
                                        <div class="doctor-item">
                                            <div class="doctor-img">
                                                <img src="{{asset('assets/client/image/avatar-mh1.jpg')}}" alt="Bs. Nguyễn Thanh Tiềm" class="img-fluid">
                                            </div>
                                            <div class="doctor-info">
                                ...
                                <div class="tab-pane fade" id="tab-y-si">
                                    <div class="doctor-list">
                                        <div class="doctor-item">
                                            <div class="doctor-img">
                                                <img src="{{asset('assets/client/image/avatar-mh1.jpg')}}" alt="Y sỹ Nguyễn Như Hoà" class="img-fluid">
                                            </div>
                                            <div class="doctor-info">
                                ...
                                <div class="tab-pane fade" id="tab-thac-si">
                                    <div class="doctor-list">
                                        <div class="doctor-item">
                                            <div class="doctor-img">
                                                <img src="{{asset('assets/client/image/avatar-mh2.jpg')}}" alt="Thạc sĩ 1" class="img-fluid">
                                            </div>
                                            <div class="doctor-info">
                                        ...
                                        <div class="doctor-item">
                                            <div class="doctor-img">
                                                <img src="{{asset('assets/client/image/avatar-mh1.jpg')}}" alt="Thạc sĩ 2" class="img-fluid">
                                            </div>
                                            <div class="doctor-info">
                                                <h3>Thạc sĩ 2</h3>
                                                <div class="rating">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="news-box">
                    ...
                    <p>Tham gia chương trình khám sức khỏe định kỳ dành cho toàn thể sinh viên và cán bộ trong trường vào tháng tới.</p>
            ...
            <div class="col-md-4">
                <div class="news-box">
                    ...
                    <p>Buổi tư vấn sức khỏe tâm lý miễn phí với chuyên gia, giúp bạn cân bằng cuộc sống học tập và công việc.</p>
                    <a href="news-details.html" class="btn btn-news">Đọc thêm</a>
                </div>
            </div>
            <div class="col-md-4">
                <div class="news-box">
                    ...
                    <p>Chương trình hiến máu nhân đạo hằng năm của trường sẽ diễn ra vào tháng tới. Hãy đăng ký và tham gia ngay!</p>
                    <a href="news-details.html" class="btn btn-news">Đọc thêm</a>
                </div>
            </div>
        </div>
