        ...
        <div class="card-body">
            <div class="content-header d-flex justify-content-between align-items-end">
                ...
                <div class="content-action">
                    <a href="{{route('admin.medical.doctor.roles.create')}}" class="btn btn-teal"><i class="ph-plus-circle me-1"></i> Tạo mới</a>
                </div>
            </div>
        </div>
    </div>
                ...
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center">Tên chuyên môn</th>
                            <th class="text-center">Hành động</th>
                        </tr>
                    </thead>
                    <tbody>
                        @if($doctor_roles->isEmpty())
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        ...
                                        <button type="button" wire:click="openDeleteModel({{ $doctor_role->id }})" class="dropdown-item text-danger">
