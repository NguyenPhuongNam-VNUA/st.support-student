<section class="section-tb-padding">
                            ...
                            <div class="tred-pro">
                                ...
                                <div class="pro-icn">
                                    <a href="javascript:void(0)" class="w-c-q-icn" 
                                        ...
                                        data-bs-target="#motelModal"
                                        data-address="{{ $motel->address }}"
    ...
    <div class = "mt-5">
        ...
        <div class="page-number style-1">
            ...
            @else
                <a href="{{ $motels->previousPageUrl() }}" class="page-link"><i class="fa fa-angle-double-left"></i></a>
            @endif
